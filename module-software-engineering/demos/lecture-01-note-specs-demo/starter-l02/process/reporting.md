...
Reports cite `note-format-spec.md` clauses as R1, R2, …; the concept of
operations as §1 … §6 and O1, O2, O3; the operations document as O1 … O4; process
rules as AUD-n, AUDCON-n, DEV-n, VER-n, RPT-n. Reports are delivered in the
conversation; a report that leads to a change is summarized in that change's
commit message.

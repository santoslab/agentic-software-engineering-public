...
| 24–30 | Change S or change R (demo Segment 3, compressed) | Diagram 2. Segment 2 was the S-side move: scope, R3, R7, 0.1 → 1.0.0, changelog. Who decided: a person, on record. Then `cat note-set-operations.md` after the scaffold: three specifications now govern the repository, each abstracting something different. |

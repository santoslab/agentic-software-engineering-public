...
| [`reversi-starter/`](reversi-starter/) | Lecture 05, Project 1 | The Project 1 starter: the Reversi concept-of-operations sketch (incomplete on purpose), the loader `CLAUDE.md`, `process/` (the Lecture 04 set), and `BACKLOG.md`. No specification, no code |

...
|---|---|---|
| `pkb-conops.md` | the bundle `kb/` as a whole; the agent's operations | §1 … §6; O1, O2, … |
| `pkb-format-spec.md` | the notes under `kb/`; `kb/index.md` and `kb/log.md` (the reserved-file rules) | R1, R2, … |
| `pkb-operations.md` (derived) | the agent's performance of each operation | O1, O2, … |
...
- **1.2** (2026-09-25) — Bound to the personal-knowledge-base repository: the
  binding table names `pkb-conops.md`, `pkb-format-spec.md`, and
  `pkb-operations.md`. Rules unchanged.
